...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"city"]];
}
...
- (IBAction)loginButtonPressed:(UIButton *)sender {
    ...
    [manager POST:urlStr parameters:userInfo progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        if (responseObject != nil) {
            ...
            [defaults setObject:[responseObject objectForKey:@"_id"] forKey:user_id];
            [defaults setObject:[responseObject objectForKey:@"email"] forKey:user_email];
